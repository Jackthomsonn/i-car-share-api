export const config = {
  ...
  APPLICATION_NAME: 'Hitch Hike',
  PORT: process.env.PORT || 8080,
  MONGO_URI: process.env.MONGO_URI || 'mongodb://localhost:27017/hitch-hike',
  MONGO_OPTIONS: {
  ...
  COOKIE_NAME: 'hitch-hike-share',
  FORGGOTEN_PASSWORD_COOKIE_NAME: 'hitch-hike-share-forgotten-password',
  EMAIL: 'no-reply@hitchhike.co.uk',
  BASE_URI: '/api',
  ...
  REFRESH_TOKEN_COOKIE_NAME: 'hitch-hike-share-refresh'
}